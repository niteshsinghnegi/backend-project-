...
const changeCurrentPassword = asyncHandler(async(req,res)=>{
 ...
 const user = await  User.findById(req.user?._id)
  ...
  return res
  .status (200)
  .json(new ApiResponse(200,{},"password changae successfully"))
...
const updateUserAvatar = asyncHandler(async(req,res)=>{
   ...
   .status(200)
   .json(
    new ApiResponse(200,user,"avatar imaged updated successfully ")
   )
})
...
const updateUserCoverImage = asyncHandler(async(req,res)=>{
     ...
     if(!coverImage.url){
        throw new ApiError("400","error while uplodaing coverImage")
